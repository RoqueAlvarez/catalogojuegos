...
?>
<form class="container mt-3" enctype="multipart/form-data">
    <div class="row justify-content-center">
        <div class="col-4 fondo">
            <div class="py-4">
                <h2 class="text-center">Registro de Jugadores</h2>
                <p class="text-center">Únete al catálogo y comparte tus opiniones sobre videojuegos.</p>
                <br>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label class="text-primary" for="usuario"><i class="fa-solid fa-envelope me-2"></i>Correo Electrónico</label>
                </div>
                <div class="form-floating mb-3">
                ...
                <div class="form-floating mb-3">
                    ...
                    <label class="text-primary" for="rol"><i class="fa-solid fa-user-shield me-2"></i>Rol</label>
                </div>
                ...
                <a href="login" class="btn btn-danger w-100"><i class="fa-solid fa-door-open me-2"></i>Iniciar sesión</a>
            </div>
        </div>
    </div>
</form>
