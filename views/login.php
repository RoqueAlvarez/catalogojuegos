    ...
    <div class="row justify-content-center">
        <div class="col-4 fondo">
            <div class="py-4">
                ...
                <h1 class="text-center">El portal del Universo Gamer</h1>
                <p class="text-center">Bienvenido a mi blog de videjuegos</p>
                <p class="text-center">Explora y descubre  títulos curiosos de distintas plataformas.</p>
                <br>
